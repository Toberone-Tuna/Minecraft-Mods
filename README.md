# Minecraft 1.21.7 "Vanilla" Fabric Mods
Fabric mods to enhance vanilla Minecraft 1.21.7.<br>
...
**Requires:** Java 21, Found [here](https://download.oracle.com/java/21/archive/jdk-21.0.7_windows-x64_bin.exe) (Computer restart required after installing)

**Minecraft Version:** Fabric 1.21.7, Found [here](https://fabricmc.net/use/installer/) (Java 21 has to be installed to use)
