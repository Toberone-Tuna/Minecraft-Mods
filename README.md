...
**Requires:** Java 17, Found [here](https://download.oracle.com/java/17/archive/jdk-17.0.11_windows-x64_bin.exe) (Computer restart required after installing)

**Minecraft Version:** Fabric 1.20.6, Found [here](https://fabricmc.net/use/installer/) (Java 17 has to be installed to use)
